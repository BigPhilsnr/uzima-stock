...
public class PurchaseReceipt {
    ...
    public PurchaseReceipt(String purchaseReceiptNo, String supplier, LocalDateTime postingDate,
    ...
    public void setPurchaseReceiptNo(String purchaseReceiptNo) { this.purchaseReceiptNo = purchaseReceiptNo; }
